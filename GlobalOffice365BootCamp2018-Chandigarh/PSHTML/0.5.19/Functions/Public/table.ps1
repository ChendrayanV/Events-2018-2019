Function table {
    <#
    .SYNOPSIS
    Create a table title in an HTML document.

    .EXAMPLE

    table
    .EXAMPLE
    table "woop1" -Class "class"

    .EXAMPLE
    table "woop2" -Class "class" -Id "MainTitle"

    .EXAMPLE
    table {"woop3"} -Class "class" -Id "MaintTitle" -Style "color:red;"
